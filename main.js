...
new_user_name.forEach((new_user_name) => {
    if (current_user_name.some((current_user_name) => current_user_name.toLowerCase() ===
...
let laptop = {
    ...
    price: 45000,
    discribe: function () {
        console.log(`Brand: ${laptop.brand}, Model: ${laptop.model}, Ram: ${laptop.ram}, Storage: ${laptop.storage}, Price: ${laptop.price}`);
    },
};
laptop.discribe();
...
console.log('\n');
let price1 = [2000, 4000, 3000, 5000];
let price2 = [6000, 9000, 8000, 7000, 10000];
...
console.log(...price1.sort(), ...price2.sort(function (a, b) {
    return a - b;
}));
// // DAY 17 
// //ques 49
...
console.log('\n');
let rantangle_size = (width, height) => width * height;
...
console.log('\n');
function dynamic_object(key, value) {
    // let obj:{
    //   [key:string]:string
    // }={};
    // obj[key]=value
...
console.log('\n');
let grade = [70, 80, 20];
let avg_func = (val1, val2) => { return val1 + val2; };
let avg_sum = grade.reduce(avg_func) / grade.length;
console.log(avg_sum);
// //DAY 20
...
console.log('\n');
var vehiclesCategory;
(function (vehiclesCategory) {
    vehiclesCategory[vehiclesCategory["car"] = 1] = "car";
    vehiclesCategory[vehiclesCategory["trucks"] = 2] = "trucks";
    vehiclesCategory[vehiclesCategory["motorcycle"] = 3] = "motorcycle";
...
function divide(num1, num2) {
    ...
    console.log(`${num1} and ${num2} of quotient: ${quotient}  and remainder: ${remainder} `);
}
divide(10, 3);
// Day 24
// Question 70
...
console.log("\n");
let functionExpressions = function (num) {
    return num * num;
};
...
console.log("\n");
let replacingText = (sentence) => {
    //return sentence.replace("JavaScript", "TypeScript")
    return sentence.replace(/JavaScript/g, "TypeScript");
    //Uses a regular expression with the 'g' flag for a global replacement
};
console.log(replacingText("JavaScript is a scripting language used to develop web pages. I love JavaScript and JavaScript is awesome!"));
// Day 29
// Question 85
...
console.log("\n");
function findingWord(sentence) {
    return sentence.indexOf("Coding");
}
console.log(findingWord("TypeScript Coding allows programmers to build programs, such as websites and apps."));
// Question 86
...
console.log("\n");
let employee = ["sarfraz", "waseem", "sajjad"];
...
console.log("\n");
let favNumber = [45, 2, 1, 3, 35, 17];
function greaterNumber(numberArray) {
...
console.log("\n");
let numbers = [45, 2, 1, 3, 35, 17];
function sumOfArray(numberArray) {
    return numberArray.reduce((accumulatedValue, currentValue) => accumulatedValue + currentValue, 0);
}
...
console.log("\n");
function gradeExpression(grade) {
    switch (grade) {
        case "A":
...
console.log("\n");
let favMovies = ["Kingkong", "Superman", "Spiderman"];
...
console.log("\n");
let multiplyParameters = (...a) => a.reduce((total, number) => total * number, 1);
...
// Day-51 Task: completed article reading
